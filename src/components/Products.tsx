    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center mb-12">
          <h2 className="text-3xl md:text-4xl font-serif font-bold mb-8">Featured Products</h2>
            ...
            {filteredProducts.map(product => (
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <Link to={`/product/${product.id}`} className="block text-lg font-medium hover:text-gray-600 transition-colors mb-2">
                    {product.name}
                  </Link>
                  <p className="text-lg font-serif">${product.price.toFixed(2)}</p>
                </div>
              </motion.div>
            ))}
          </AnimatePresence>
